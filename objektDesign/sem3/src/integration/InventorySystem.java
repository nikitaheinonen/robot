...
public class InventorySystem {
    ...
    private void addItems(){
        inventory.put("Tomat", new Item(new ItemDTO(new Amount(20), "Tomat", new Amount(8)), "Tomat", new Amount(Integer.MAX_VALUE)));
        inventory.put("Gurka", new Item(new ItemDTO(new Amount(30), "Gurka", new Amount(15)), "Gurka", new Amount(Integer.MAX_VALUE)));
        inventory.put("Cola", new Item(new ItemDTO(new Amount(42), "Cola", new Amount(10)), "Cola", new Amount(Integer.MAX_VALUE)));
        inventory.put("Ris", new Item(new ItemDTO(new Amount(5), "Ris", new Amount(20)), "Ris", new Amount(Integer.MAX_VALUE)));
    }
}
